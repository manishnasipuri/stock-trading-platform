...
function TickietCreation() {
    return (  
        <div className='container'>
                <div className='row p-5 mt-5 mb-5'>
                    <h1 className='fs-3 text-center'>To create a tickiet , select a relevant topic</h1>
                    ...
                    <div className='col-4 p-5 mt-2 mb-2'>
                        <h5 className=''> <i class="fa-solid fa-circle-user"></i> Your Account</h5>
                    ...
                    <div className='col-4 p-5 mt-2 mb-2'>
                        <h5 className=''> <i class="fa-solid fa-chart-area"></i> Your Money</h5>
                            <a href='' style={{textDecoration:"none", lineHeight:"2"}}>IPO</a> <br></br>
                            <a href='' style={{textDecoration:"none", lineHeight:"2"}}>Trading FAQs</a><br></br>
                            <a href='' style={{textDecoration:"none", lineHeight:"2"}}>Margin Trading Facility (MTF) and Margins</a><br></br>
                            <a href='' style={{textDecoration:"none", lineHeight:"2"}}>Alerts and Nudges</a><br></br>
                            <a href='' style={{textDecoration:"none", lineHeight:"2"}}>General</a>
                    </div>
                    <div className='col-4 p-5 mt-2 mb-2'>
                        <h5 className=''> <i class="fa-solid fa-credit-card"></i> Funds</h5>
                    ...
                    <div className='col-4 p-5 mt-2 mb-2'>
                        <h5 className=''> <i class="fa-regular fa-circle"></i> Console</h5>
                            ...
                            <a href='' style={{textDecoration:"none", lineHeight:"2"}}>Reports</a><br></br>
                    ...
                    <div className='col-4 p-5 mt-2 mb-2'>
                        <h5 className=''> <i class="fa-solid fa-coins"></i> Coin</h5>
                            ...
                            <a href='' style={{textDecoration:"none", lineHeight:"2"}}>Payments and Orders</a>
                    </div>
                </div>
            </div>
    );
...
export default TickietCreation;